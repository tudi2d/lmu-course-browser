...
export const CourseDetailsTab: React.FC<CourseDetailsTabProps> = ({ courseData }) => {
  return (
    <>
...
const AdditionalDetailsAccordion: React.FC<AdditionalDetailsAccordionProps> = ({ courseData }) => {
  return (
